...
class SearchItemsRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'artist' => 'string',
        'author' => 'string',
        'availability' => '\Jakiboy\paapi5\lib\Availability',
        'brand' => 'string',
        'browseNodeId' => 'string',
        'condition' => '\Jakiboy\paapi5\lib\Condition',
        'currencyOfPreference' => 'string',
        'deliveryFlags' => '\Jakiboy\paapi5\lib\DeliveryFlag[]',
        'itemCount' => 'int',
        'itemPage' => 'int',
        'keywords' => 'string',
        'languagesOfPreference' => 'string[]',
        'marketplace' => 'string',
        'maxPrice' => '\Jakiboy\paapi5\lib\MaxPrice',
        'merchant' => '\Jakiboy\paapi5\lib\Merchant',
        'minPrice' => '\Jakiboy\paapi5\lib\MinPrice',
        'minReviewsRating' => '\Jakiboy\paapi5\lib\MinReviewsRating',
        'minSavingPercent' => '\Jakiboy\paapi5\lib\MinSavingPercent',
        ...
        'resources' => '\Jakiboy\paapi5\lib\SearchItemsResource[]',
        'searchIndex' => 'string',
        'sortBy' => '\Jakiboy\paapi5\lib\SortBy',
        'title' => 'string'
    ];
     ...
     * Gets availability
     *
     * @return \Jakiboy\paapi5\lib\Availability
     */
     ...
     * Sets availability
     *
     * @param \Jakiboy\paapi5\lib\Availability $availability availability
     *
     * @return $this
     */
     ...
     * Gets deliveryFlags
     *
     * @return \Jakiboy\paapi5\lib\DeliveryFlag[]
     */
     ...
     * Sets deliveryFlags
     *
     * @param \Jakiboy\paapi5\lib\DeliveryFlag[] $deliveryFlags deliveryFlags
     *
     * @return $this
     */
     ...
     * Gets maxPrice
     *
     * @return \Jakiboy\paapi5\lib\MaxPrice
     */
     ...
     * Sets maxPrice
     *
     * @param \Jakiboy\paapi5\lib\MaxPrice $maxPrice maxPrice
     *
     * @return $this
     */
     ...
     * Gets minPrice
     *
     * @return \Jakiboy\paapi5\lib\MinPrice
     */
     ...
     * Sets minPrice
     *
     * @param \Jakiboy\paapi5\lib\MinPrice $minPrice minPrice
     *
     * @return $this
     */
     ...
     *
     * @return \Jakiboy\paapi5\lib\MinReviewsRating
     */
     ...
     *
     * @param \Jakiboy\paapi5\lib\MinReviewsRating $minReviewsRating minReviewsRating
     *
     * @return $this
     */
     ...
     *
     * @return \Jakiboy\paapi5\lib\MinSavingPercent
     */
     ...
     *
     * @param \Jakiboy\paapi5\lib\MinSavingPercent $minSavingPercent minSavingPercent
     *
     * @return $this
     */
     ...
     * Gets resources
     *
     * @return \Jakiboy\paapi5\lib\SearchItemsResource[]
     */
     ...
     * Sets resources
     *
     * @param \Jakiboy\paapi5\lib\SearchItemsResource[] $resources resources
     *
     * @return $this
     */
     ...
     * Gets sortBy
     *
     * @return \Jakiboy\paapi5\lib\SortBy
     */
     ...
     * Sets sortBy
     *
     * @param \Jakiboy\paapi5\lib\SortBy $sortBy sortBy
     *
     * @return $this
     */
