...
class OfferCondition implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'locale' => 'string',
        'value' => 'string',
        'subCondition' => '\Jakiboy\paapi5\lib\OfferSubCondition'
    ];
     ...
     * Gets subCondition
     *
     * @return \Jakiboy\paapi5\lib\OfferSubCondition
     */
     ...
     * Sets subCondition
     *
     * @param \Jakiboy\paapi5\lib\OfferSubCondition $subCondition subCondition
     *
     * @return $this
     */
